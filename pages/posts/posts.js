    ...
    const content = [
      {
        ...
        content:
          "8月9号，LPL常规赛收官之战结束，在事关季后赛轮次的比赛中关键对局中，SN战胜了FPX，为本赛季常规赛画上句号。进入季后赛的战队依次为，TES、JDG、IG、SN、V5、LGD、WE、FPX",
        imgSrc: "/images/lpl.png",
        reading: 102,
        detail:
          "8月9号，LPL常规赛收官之战结束，在事关季后赛轮次的比赛中关键对局中，SN战胜了FPX，为本赛季常规赛画上句号。进入季后赛的战队依次为，TES、JDG、IG、SN、V5、LGD、WE、FPX。既有传统四强，又有新崛起的黑马。本文主要是从上路的大改动展开，引发对所有其他的影响。牵一发而动全身，上路一旦回归carry上单版本，对野区和中路的影响是显而易见的。而下路在艾希大砍一刀之后，女警的过于强势，使她只能出现在BAN位上，因此主流下路还是会回归功能性下路英雄。由此，可以对应各位选手的英雄池，对应各支战队的战术储备，漫长的季后赛，考验的就是各队适应版本的能力。",
        collection: 92,
        dateTime: "24小时前",
        ...
        music: {
          ...
          title: "空-徐海俏",
          coverImg:
            "https://y.gtimg.cn/music/photo_new/T002R300x300M000002sNbWp3royJG_1.jpg?max_age=2592000",
        },
      },
      ...
      },
      {
        ...
        content:
          "iG在本赛季大胆更换了下路组合，没有人料想到全新阵容能够迅速起飞，iG在常规赛中只输了两场比赛，队伍的整体状态非常出色。",
        imgSrc: "/images/bestplayers.png",
        reading: 102,
        detail:
          "iG在本赛季大胆更换了下路组合，没有人料想到全新阵容能够迅速起飞，iG在常规赛中只输了两场比赛，队伍的整体状态非常出色。Puff和Southwind的到来，为iG带来了全新的战术打法，而Rookie和TheShy的发挥一如既往稳定。作为世界冠军和LPL卫冕冠军，FPX在本赛季保持了稳定的发挥，Khan和GimGoon轮番上阵，为FPX带来了不同的战术部署。如今的FPX打法非常多变，上中下都能够成为carry的战术点，加上Tian的前期积极进攻，整支队伍在对线方面得到了相当程度的提升。FPX渴望延续良好表现，捍卫他们的冠军头衔。",
        collection: 26,
        dateTime: "24小时前",
      ...
      },
      {
        title: "飞驰的人生",
        content:
          "《飞驰人生》应该是韩寒三部曲的第三部。从《后悔无期》到《乘风破浪》再到《飞驰人生》",
        imgSrc: "/images/jumpfly.png",
        reading: 96,
        detail:
          "《飞驰人生》应该是韩寒三部曲的第三部。从《后悔无期》到《乘风破浪》再到《飞驰人生》，故事是越讲越直白，也越来越贴近大众。关于理想、关于青春永远是韩寒作品的主题。也许生活确实像白开水，需要一些假设的梦想，即使大多数人都不曾为梦想努力过，但我们依然爱看其他人追梦，来给自己带来些许的慰藉。",
        collection: 26,
        dateTime: "21小时前",
